...
<title>菜单信息添加</title>
	...
	<body>
	    ...
	    <div class="title_name">添加菜单信息</div>
	    <form action="menuaddgodb" method="post" id="form-admin-add">
	    <ul>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i>*</i>菜单名称：</label>
	     <div class="formControls col-xs-6">
	     <input type="text" placeholder="菜单名称" class="input-text col-xs-12" value="" id="title" name="title" datatype="*2-16" nullmsg="菜单名称不能为空"></div>
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>菜单链接：</label>
		 <div class="formControls col-xs-6">
		 <input type="text" placeholder="菜单链接" id="url" name="url" autocomplete="off" value="" class="input-text col-xs-12" datatype="*" nullmsg="菜单链接不能为空">
		</div>
	     <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     ...
	     <li class="clearfix">
				...
				<div class="formControls col-xs-6">
					<textarea name="remark" id="remark" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"></textarea>
