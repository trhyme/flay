...
<body>
	<body>
	    ...
	    <form action="bannerinsert" method="post" id="form-admin-add">
	    <ul>
	     <li class="clearfix">
	    ...
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     ...
	     <div class="formControls col-xs-6">
	     <input type="text" class="input-text col-xs-12" value="" placeholder="Banner链接" id="htmlurl" name="htmlurl" nullmsg="Banner链接不能为空" ></div>
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
