...
<body>
	<div class="margin Competence_style" id="page_style">
		...
		<a href="giftsaddpage"  class="btn button_btn bg-deep-blue" title="礼物信息添加"><i class="fa  fa-edit"></i>信息</a>
	       ...
	       <table id="sample_table" class="table table_list table_striped table-bordered dataTable no-footer">
			 <thead>
				<tr>
				  ...
				  <th>用户ID</th>
				  <th>时间</th>
				  <th style="max-width:250px;">广播内容</th>
				  <th class="hidden-280">操作</th>
	             </tr>
			    </thead>
	             <tbody>
	             	<c:forEach items="${broadcastlist}" var="lists">
	             		<tr>
						...
						<td>
							<c:if test="${lists.stratus eq 1}">
								<a title="屏蔽" href="broadcasstratus?id=${lists.id}&stra=0" class="btn button_btn btn-danger">屏蔽</a>
							</c:if>
							<c:if test="${lists.stratus eq 0}">
								<a title="开启" href="broadcasstratus?id=${lists.id}&stra=1" class="btn button_btn bg-deep-blue">开启</a>
							</c:if>
	...
	<script type="text/javascript" src="js/jquery.appbroadcastpagination.js"></script>
