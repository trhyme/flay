...
<body>
	<body>
	    ...
	    <div class="title_name">礼物设置</div>
	    <form action="giftsinsert" method="post" id="form-admin-add">
	    <ul>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>标 题：</label>
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" value="" id="titles" name="titles" datatype="*1-16" nullmsg="礼物名称不能为空" placeholder="礼物名称"></div>
	     ...
	     <li class="clearfix">
		     ...
		     <div class="formControls col-xs-6">
		     <input type="number" class="input-text col-xs-12" value="" placeholder="礼物价格(虚拟货币)" id="prices" name="prices" datatype="*1-16" nullmsg="礼物价格不能为空"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	         <li class="clearfix">
