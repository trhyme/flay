...
<body>
	<body>
	    ...
	    <div class="title_name">系统消息推送添加</div>
	    <form action="insertintosystemnews" method="post" id="form-admin-add" onsubmit="return checktest();">
	    <ul>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i>*</i>标 题：</label>
	     <div class="formControls col-xs-6">
	     <input type="text" class="input-text col-xs-12" value="" placeholder="系统消息标题" id="titles" name="titles" datatype="*1-16" nullmsg="系统消息标题不能为空" ></div>
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     ...
	     <div class="formControls col-xs-6">
	     <input type="text" class="input-text col-xs-12" value="" placeholder="跳转链接" id="htmlurl" name="htmlurl" ></div>
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
	     ...
	     <li class="clearfix">
				...
				<div class="formControls col-xs-6">
					<textarea name="remarks" id="remarks" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" nullmsg="系统消息内容不能为空" onkeyup="checkLength(this);"></textarea>
