...
<body>
	<div class="margin Competence_style" id="page_style">
		...
		<a href="addadverspage"  class="btn button_btn bg-deep-blue" title="弹窗广告信息添加"><i class="fa  fa-edit"></i>弹窗广告信息添加</a>
	       ...
	       <table id="sample_table" class="table table_list table_striped table-bordered dataTable no-footer">
			 <thead>
				<tr>
	             ...
	             <tbody>
	             	<c:forEach items="${adverslist}" var="lists">
	             		<tr>
							<td>${lists.name}</td>
							<td>
								<a href="${lists.pic}" target="_blank"><img src="${lists.pic}" style="width:50px;height:50px;"></a>
							</td>
							<td>
								<a href="${lists.url}" target="_blank">${lists.url}</a></td>
							<td>
								${lists.begintime}至${lists.endsstime}
							</td>
							<td>${lists.work}</td>
							
						<td>
		                 <a title="编辑" href="adversupdatepage?ids=${lists.id}" class="btn button_btn bg-deep-blue">编辑</a>        
	...
	<script type="text/javascript" src="js/jquery.adverspagination.js"></script>
