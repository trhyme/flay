...
<body>
	<div class="margin Competence_style" id="page_style">
		...
		<a href="beckoningaddpage"  class="btn button_btn bg-deep-blue" title="添加心动信息设置"><i class="fa  fa-edit"></i>&nbsp;添加心动信息设置</a>
	       ...
	       <table id="sample_table" class="table table_list table_striped table-bordered dataTable no-footer">
			 <thead>
				<tr>
	             ...
	             <tbody>
	             	<c:forEach items="${becklist}" var="lists">
	             		<tr>
	             		<td>${lists.id}</td>
						<td>${lists.beginnum} -- ${lists.endnumes}</td>
						<td>
							<img src="${lists.beckurls}" style="width:50px;height:50px;">
						</td>
						<td>${lists.contents}</td>
						<td>
		                 <a title="编辑" onclick="Competence_modify('560')" href="updatebaeckpage?id=${lists.id}" class="btn button_btn bg-deep-blue">编辑</a>        
	...
	<script type="text/javascript" src="js/jquery.beckoningpagination.js"></script>
