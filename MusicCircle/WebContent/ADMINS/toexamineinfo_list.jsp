 ...
 <div class="defray_style">
	...
	<div class="operation clearfix">
		   ...
		   <div class="search  clearfix" style="width:100%;">
		   	   <form action="toexaminelist" method="get">
	        ...
	        <table id="sample_table" class="table table_list table_striped table-bordered dataTable no-footer">
			 <thead>
				<tr>
	             ...
	             <tbody>
	             	<c:forEach items="${toexaminelist}" var="lists">
	             		<tr>
						<td>${lists.uuid}</td>
						<td>${lists.uphone}</td>
						<td>${lists.unames}</td>
...
function add_payment(index ){
	...
	<script type="text/javascript" src="js/jquery.toexamineinfopagination.js"></script>
