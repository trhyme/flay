...
<body>
	<body>
	    ...
	    <div class="title_name">弹窗广告信息修改</div>
	    <form action="updateadverstodb" method="post" id="form-admin-add">
	    <ul>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>标 题：</label>
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" value="${advone.name}" placeholder="弹窗广告名称" id="advtitles" name="advtitles" datatype="*1-16" nullmsg="弹窗广告名称不为空" placeholder="弹窗广告名称"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>图 片：</label>
		 <div class="formControls col-xs-6">
		 <input type="hidden" id="vdaid" name="vdaid" readonly="readonly" value="${advone.id}">
		 <input type="hidden" id="picName" name="picName" readonly="readonly" value="${advone.pic}">
	     ...
	     <li class="clearfix">
		     ...
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" value="${advone.url}" placeholder="H5页面路径" id="h5url" name="h5url" datatype="*" nullmsg="跳转路径不能为空" placeholder="点击跳转路径"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
	     ...
	     <li class="clearfix">
		     ...
		     <div class="formControls col-xs-6">
		     <input type="date" class="input-text col-xs-12" value="${advone.begintime}" placeholder="开始时间" id="begintime" name="begintime" datatype="*" nullmsg="开始时间不能为空" placeholder="开始时间"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>结束时间：</label>
		     <div class="formControls col-xs-6">
		     <input type="date" class="input-text col-xs-12" value="${advone.endsstime}" placeholder="结束时间" id="endsstime" name="endsstime" datatype="*" nullmsg="结束时间不能为空" placeholder="结束时间"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	         <li class="clearfix">
