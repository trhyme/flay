...
<body>
	<body>
	    ...
	    <div class="title_name">会员类型修改</div>
	    <form action="membergradeupdate" method="post" id="form-admin-add">
	    <ul>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>会员名称：</label>
		     <div class="formControls col-xs-6">
		     <input type="hidden" id="id" name="id" value="${membergrad.id}" readonly="readonly">
		     <input type="text" class="input-text col-xs-12" value="${membergrad.mname}" id="mname" name="mname" datatype="*1-16" nullmsg="会员名称不能为空" placeholder="会员名称"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>展示图片：</label>
		 <div class="formControls col-xs-6">
		 <input type="hidden" id="picName" name="picName" readonly="readonly" value="${membergrad.picurl}">
	     ...
	     <li class="clearfix">
		     ...
		     <div class="formControls col-xs-6">
		     <input type="number" class="input-text col-xs-12" value="${membergrad.prices}" placeholder="会员价格" id="prices" name="prices" datatype="*0-16" step="0.01" nullmsg="会员价格不能为空"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>会员说明：</label>
		     <div class="formControls col-xs-6">
		     <input type="text" class="input-text col-xs-12" value="${membergrad.remark}" id="remark" name="remark" datatype="*1-16" nullmsg="会员说明不能为空" placeholder="会员说明"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	     <li class="clearfix">
		     <label class="label_name col-xs-2 col-lg-2"><i>*</i>使用天数：</label>
		     <div class="formControls col-xs-6">
		     <input type="number" class="input-text col-xs-12" value="${membergrad.daynum}" placeholder="会员使用天数" id="daynum" name="daynum" datatype="*1-16" nullmsg="使用天数不能为空"></div>
		    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     </li>
	         <li class="clearfix">
	    ...
	    <div class="Notice_style l_f">
	      	<img alt="" id="cmplogo_changeshow" src="${membergrad.picurl}" style="max-height:400px;">
	    </div>
	</div>
	</body>
	<script>
