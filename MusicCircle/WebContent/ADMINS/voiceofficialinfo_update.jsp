...
<title>录制声音文案修改</title>
</head>
	<body>
		<div class="margin add_administrator" id="page_style">
	    <div class="add_style add_administrator_style">
	    <div class="title_name">录制声音文案修改</div>
	    <form action="voicesofferupdate" method="post" id="form-admin-add" onsubmit="return checkLoad();">
	    <ul>
	     <li class="clearfix">
	     <label class="label_name col-xs-2 col-lg-2"><i>*</i>文案标题：</label>
	     <div class="formControls col-xs-6">
	     <input type="hidden" id="id" name="id" value="${voicesoffer.id}">
	     <input type="text" placeholder="文案标题" class="input-text col-xs-12" value="${voicesoffer.title}" id="title" name="title" datatype="*2-16" nullmsg="文案标题不能为空"></div>
	    <div class="col-4"> <span class="Validform_checktip"></span></div>
	     ...
	     <li class="clearfix">
				...
				<div class="formControls col-xs-6">
					<textarea name="infos" id="infos" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);" nullmsg="文案标题不能为空">${voicesoffer.infos}</textarea>
