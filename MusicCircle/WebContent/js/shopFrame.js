		   ...
		   //隐藏对象点击事件
			...
			content.removeClass("full_screen");					
		     ...
		     if(settings.header===0){
			    ...
			    leftmenu.prepend('<div class="user_operating"><a class="btn_dropout" href="adminloginout" id="Exit_system"><i class="fa fa-user-times"></i>退出系统</a><a href="#" class="btn_usernfo"><i class="fa fa-user"></i>个人信息</a></div>');
			 }
