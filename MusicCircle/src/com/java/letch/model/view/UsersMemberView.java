...
public class UsersMemberView implements Serializable{
	public UsersMemberView(){}
	//属性
	//属性
	private int id;			//主键ID
	...
	public Integer getDisabls() {
		return disabls;
	}
	public void setDisabls(Integer disabls) {
