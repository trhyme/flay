package com.java.letch.app.redis.tools;
...
public class RedisUtil {
    ...
    //Redis服务器IP  
    private static String ADDR_ARRAY = "120.77.62.203";  
  
    //Redis的端口号  
    private static int PORT = 6379;  
  
    //访问密码  
    private static String AUTH = "leqtch147852369";  
    //可用连接实例的最大数目，默认值为8；  
    ...
    //超时时间  
    private static int TIMEOUT = 1*60*60;  
