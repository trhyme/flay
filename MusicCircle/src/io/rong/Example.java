...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "3argexb63051e";//替换成您的appkey
		String appSecret = "6V3K9VKCejKD";//替换成匹配上面key的secret
		...
		/*// 获取 Token 方法 
		TokenResult userGetTokenResult = rongCloud.user.getToken("24146", "username", "http://www.rongcloud.cn/images/logo.png");
		System.out.println("getToken:  " + userGetTokenResult.toString());
		
		// 刷新用户信息方法 
		CodeSuccessResult userRefreshResult = rongCloud.user.refresh("24146", "username", "http://www.rongcloud.cn/images/logo.png");
		System.out.println("refresh:  " + userRefreshResult.toString());*/
		
		// 检查用户在线状态 方法 
		/*CheckOnlineResult userCheckOnlineResult = rongCloud.user.checkOnline("22222");
		System.out.println("checkOnline:  " + userCheckOnlineResult.toString());
		System.out.println(userCheckOnlineResult.getStatus());
		
		// 发送单聊消息方法（一个用户向另外一个用户发送消息，单条消息最大 128k。每分钟最多发送 6000 条信息，每次发送用户上限为 1000 人，如：一次发送 1000 人时，示为 1000 条消息。） 
		String[] messagePublishPrivateToUserId = {"20000"};
		VoiceMessage messagePublishPrivateVoiceMessage = new VoiceMessage("hello", "helloExtra", 20L);
		CodeSuccessResult messagePublishPrivateResult = rongCloud.message.publishPrivate("22222", messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush", "{\"pushData\":\"hello\"}", "4", 0, 0, 0, 0);
